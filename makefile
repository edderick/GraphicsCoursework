all:
	g++ main.cpp object.cpp material.cpp viewer.cpp utils.cpp mtlloader.cpp objloader.cpp -I /usr/cslib/include -I include -L /usr/cslib -L lib -l glfw -l GLEW -l pthread -l Xrandr -l glimg -l glload
