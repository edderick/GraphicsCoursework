all:
	g++ main.cpp animutator.cpp object.cpp skybox.cpp material.cpp tour.cpp viewer.cpp utils.cpp textgenerator.cpp mtlloader.cpp objloader.cpp heightmaploader.cpp geometrygenerator.cpp -I /usr/cslib/include -I include -L /usr/cslib -L lib -l glfw -l GLEW -l pthread -l Xrandr -l glimg -l glload
